...
class ResponseCode{
  ...
  static const int TOKEN_ERROR = 300;// failure,ERROR token
...
class ResponseMessage{
  ...
  static const String NO_CONTENT = 'no content find'; //success with no data(no coennect)
  ...
  static const String NO_INTERNET_CONNECTION_AR = 'لو سمحت افحص الانترنت لديك';
